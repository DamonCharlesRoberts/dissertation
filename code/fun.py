...
class colorDetection:
    """
        Name: colorDetection
        Notes:
            - Description: Class for colorDetection
    """
    def preProcess(self,img,inter,size=[224,224]):
        """
        ...
        return resized
    #** Color detection
    def colorDetector(self,img,color_upper=[255,255,255],color_lower=[255,255,255]):
        """
        ...
        # Transform image
        img_transformed = self.preProcess(img=img, inter=cv2.INTER_AREA)
        # calculate scale
