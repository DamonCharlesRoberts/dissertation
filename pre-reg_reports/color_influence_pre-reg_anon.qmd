...
::: {#fig-national-conventions layout-ncol=2}

![1992 GOP National convention (Photo by: [Los Angeles Times/Getty Images](https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.gettyimages.co.nz%2Fphotos%2F1992-republican-national-convention&psig=AOvVaw3dUd98mjD2Ve6ALeTdoZUw&ust=1676648016044000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCJDo4Lqymv0CFQAAAAAdAAAAABAD))](../assets/images/gop_national_convention_1992.jpg){#fig-1992}
![1992 Democratic National Convention (Photo by: [Joe Sohm/Getty Images](https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.gettyimages.com%2Fphotos%2F1992-democratic-national-convention&psig=AOvVaw0JKMU3ZwoNZcSCGT7Bm6Kg&ust=1676649143160000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCLDW1_qymv0CFQAAAAAdAAAAABAI))](../assets/images/dnc_1992.jpg)
![2008 GOP National convention (Photo by: [Justin Sullivan/Getty Images](https://www.mprnews.org/story/2008/09/01/burgos))](../assets/images/gop_national_convention_2008.jpg){#fig-2008}
![2008 Democratic National Convention (Photo by: [Paul Richards/Getty Images](https://www.mprnews.org/story/2008/08/28/2008-democratic-national-convention-day-4))](../assets/images/dnc_2008.jpg)
...
To examine whether the use of colors on yard signs varies systematically depending on the electoral context, using the `selenium` [@selenium] and `time` [@time] `python` [@python] packages, I collect images from 2018, 2020, and 2022 Congressional elections for the House of Representatives across the United States. These yard signs are pulled together on one website by the Center for American Politics and Design^[See: https://www.politicsanddesign.com/]. With these data, I detect the percentage of the "Republican Red" and "Democratic Blue" on the yard signs. I then use redistricting data from the [MIT election lab and Redistricting Data Hub](https://redistrictingdatahub.org/data/about-our-data/) to determine districts that did and did not have changes in the 5-year rolling average partisan vote share but that are also nationally representative. As there are a number of external factors that may effect choice in yard sign color besides perceptions of how it may attract voters, this threatens my ability to make claims about any estimation of an Average Treatment Effect ^[ $\frac{1}{n}\sum{}{i}(Y_i(d=1) - Y_i(d=0))$ [see @lundberg_et-al_2021_asr]]. Instead these data are used to perform a synthetic control design to give me causal leverage over the role that electoral context has on the proportion of partisan colors (i.e., red and blue) on yard signs relative to non-partisan colors by estimating a Local Average Treatment Effect ^[$E[(Y^1_i - Y^0_i) | d^1_i - d^0_i = 1]$ [see @cunningham_2021_yup]] on districts that were redistricted but vary in whether the redistricting leads to a partisan gerrymandered district or not. This analysis aims to bear evidence on the hypothesis that campaigns respond to the preferences of partisan voters and adjust their branding as a result. In this case, the branding is the color of the yard sign. First, I'll explain how I collected data on the proportion of partisan and non-partisan colors on these yard signs from the [Center for American Politics and Design](https://www.politicsanddesign.com).
