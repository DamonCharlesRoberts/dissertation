...
<!--
  TODO: 
    - Change the tense of Studies 1 and 2 to be more anticipatory
    - Add a bit more in terms of beefing up details on the analytical strategies
-->
...
I therefore reach out to a number of relatively easy to contact campaign staff for national campaigns and simply ask them "how do you decide what colors to put on a yard sign?"

With the handful of these informal interviews, I intend to see whether campaigns percieve that a design choice as simple as color matters for their campaign and what message they are sending to voters. 

<!--
  TODO:
    - Include my pre-test from SPS
-->
<!--
  TODO:
    - Beef up the discussion section a bit more.
-->
# Discussion

Together, the evidence from [Study 1](#sec-study-1) and [Study 2](#sec-study-2) not only demonstrates that campaigns percieve that the color choices they make matter for voters and respond to electoral contexts as a result, but the evidence also provides support for these perceptions as well. 

Not only do yard signs matter for electoral strategy, outcomes, and for voter attitudes and perceptions, but that the color of the yard signs are a partial explanation for these phenomenon.
