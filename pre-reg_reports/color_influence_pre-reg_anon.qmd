...
In this first part of [Study 2](#sec-study-2), I do a number of informal interviews with managers of national, state, and local campaigns. In these interviews, I simply ask the campaign managers: "what goes into your decision for the colors to put on your yard sign?" The goal of this open-ended question is to hear from the practitioners whether they perceive the yard sign color as a strategic decision for the campaign. I then follow-up to ask "do you think that the color choices you make for the yard signs matter to voters?" The goal of this question is to examine whether practitioners intuitively perceive their strategic choices to have efficacy in the election. Finally, I ask them "if colors matter and you choose to use them strategically, do you use certain colors to attract certain groups of voters that may not be reliably in your base of support?" The goal of this final question is to get at the argument that the colors that campaigns use are meant as a way to communicate the partisan and ideological alignment of the candidate with the voters.
...
To address these remaining questions, I employ a second part of [Study2](#sec-study-2) which relies upon observational data and leverages congressional redistricting following the 2020 National Census to examine whether the partisan context of a district is associated with changes to color choices for campaigns in that same district.
