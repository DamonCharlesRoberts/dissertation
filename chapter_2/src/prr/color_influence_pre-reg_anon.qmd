...
if (params$replicate == TRUE) {
  # fit the model
  source(
    "./pre-test/04_pre-test_party_model.R"
  )
  # load the stored model object
  load(
    "../../data/models/prr/pre-test/pre-test_party_model.RDS"
  )
} else (
  # load the stored model object
  load(
...
if (params$replicate == TRUE) {
  # fit the model
  source(
    "./pre-test/05_pre-test_vote_model.R"
  )
  # load the stored model object
  load(
...
+=============+=============================================================================+
| n = 200     | -   Red treatment: `r sprintf('%.3f', mean(modelDiscrepancies[[1]][,1]))`                
|             |                                                                             
