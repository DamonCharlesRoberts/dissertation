...
+=============+=============================================================================+
| n = 200     | -   Red treatment: `r sprintf('%.3f', modelDiscrepancies[[1]][,1])`                
|             |                                                                             
|             | -   Blue treatment: `r sprintf('%.3f', modelDiscrepancies[[1]][,2])`               
|             |                                                                             
|             | -   Age: `r sprintf('%.3f', modelDiscrepancies[[1]][,3])`                          
|             |                                                                             
|             | -   Red treatment $\times$ Age: `r sprintf('%.3f', modelDiscrepancies[[1]][,4])`   
|             |                                                                             
|             | -   Blue treatment $\times$ Age: `r sprintf('%.3f', modelDiscrepancies[[1]][,5])`  
|             |                                                                             
|             | -   Attention: `r sprintf('%.3f', modelDiscrepancies[[1]][,6])`                    
|             |                                                                             
|             | -   Knowledge: `r sprintf('%.3f', modelDiscrepancies[[1]][,7])`                    
+-------------+-----------------------------------------------------------------------------+
| n = 400     | -   Red treatment: `r sprintf('%.3f', modelDiscrepancies[[2]][,1])`                
|             |                                                                             
|             | -   Blue treatment: `r sprintf('%.3f', modelDiscrepancies[[2]][,2])`               
|             |                                                                             
|             | -   Age: `r sprintf('%.3f', modelDiscrepancies[[2]][,3])`                          
|             |                                                                             
|             | -   Red treatment $\times$ Age: `r sprintf('%.3f', modelDiscrepancies[[2]][,4])`   
|             |                                                                             
|             | -   Blue treatment $\times$ Age: `r sprintf('%.3f', modelDiscrepancies[[2]][,5])`  
|             |                                                                             
|             | -   Attention: `r sprintf('%.3f', modelDiscrepancies[[2]][,6])`                    
|             |                                                                             
|             | -   Knowledge: `r sprintf('%.3f', modelDiscrepancies[[2]][,7])`                    
+-------------+-----------------------------------------------------------------------------+
| n = 600     | -   Red treatment: `r sprintf('%.3f', modelDiscrepancies[[3]][,1])`                
|             |                                                                             
|             | -   Blue treatment: `r sprintf('%.3f', modelDiscrepancies[[3]][,2])`               
|             |                                                                             
|             | -   Age: `r sprintf('%.3f', modelDiscrepancies[[3]][,3])`                          
|             |                                                                             
|             | -   Red treatment $\times$ Age: `r sprintf('%.3f', modelDiscrepancies[[3]][,4])`   
|             |                                                                             
|             | -   Blue treatment $\times$ Age: `r sprintf('%.3f', modelDiscrepancies[[3]][,5])`  
|             |                                                                             
|             | -   Attention: `r sprintf('%.3f', modelDiscrepancies[[3]][,6])`                    
|             |                                                                             
|             | -   Knowledge: `r sprintf('%.3f', modelDiscrepancies[[3]][,7])`                    
+-------------+-----------------------------------------------------------------------------+
| n = 800     | -   Red treatment: `r sprintf('%.3f', modelDiscrepancies[[4]][,1])`                
|             |                                                                             
|             | -   Blue treatment: `r sprintf('%.3f', modelDiscrepancies[[4]][,2])`               
|             |                                                                             
|             | -   Age: `r sprintf('%.3f', modelDiscrepancies[[4]][,3])`                          
|             |                                                                             
|             | -   Red treatment $\times$ Age: `r sprintf('%.3f', modelDiscrepancies[[4]][,4])`   
|             |                                                                             
|             | -   Blue treatment $\times$ Age: `r sprintf('%.3f', modelDiscrepancies[[4]][,5])`  
|             |                                                                             
|             | -   Attention: `r sprintf('%.3f', modelDiscrepancies[[4]][,6])`                    
|             |                                                                             
|             | -   Knowledge: `r sprintf('%.3f', modelDiscrepancies[[4]][,7])`                    
+-------------+-----------------------------------------------------------------------------+
