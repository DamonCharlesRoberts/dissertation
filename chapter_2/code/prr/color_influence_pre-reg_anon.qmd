...
format:
  pdf:
    ...
    latex-output-dir: "../../pre-reg_reports"
nocite: |
...
![Republicans pre-2000](%22../../assets/images/rnc_logo_pre-2000.png%22){#fig-republican}

![Democrats pre-2000](%22../../assets/images/dnc_logo_1960.png%22){#fig-democrat}

![Republicans 2023](%22../../assets/images/rnc_logo_2023.png%22){#fig-republican-post}

![Democrats 2023](%22../../assets/images/dnc_logo_2023.png%22){#fig-democrat-post}
...
img = cv2.imread("../../data/pre-reg_reports/gop_2022.png")

# Detect colors
percent, img_transformed, result = colorDetector(img = img, color_upper = red_higher, color_lower = red_lower)

transformed=cv2.imwrite("../../data/pre-reg_reports/gop_2022_transformed.png", img_transformed) # save transformed image

masked=cv2.imwrite("../../data/pre-reg_reports/gop_2022_detected.png", result) # save masked image
```

::: {#fig-color-detection-example layout-ncol="2"}
![Resized original image](%22../../data/pre-reg_reports/gop_2022_transformed.png%22){#fig-resized}

![Masked](%22../../data/pre-reg_reports/gop_2022_detected.png%22){#fig-masked}
...
box::use(
    haven[read_dta],
    data.table[...],
    #dplyr[mutate, case_when, select, rename],
...
data[['original']] = setDT(read_dta('../../data/pre-reg_reports/pre-test/sps1.dta'))
...
I randomly assign participants to three conditions. The conditions prompt subjects to "Imagine that \[they\] are driving along a road and see this yard sign" with the same message "Vote for Riley." The conditions vary on the color of the background for the image.[^13] In the control condition, the background was white. Then I had a red yard sign and a blue yard sign condition. I asked participants questions operationalized as outcomes of interest on a separate screen.

[^13]: The Appendix contains the images used for the treatments and the particular wording for the dependent variables.
